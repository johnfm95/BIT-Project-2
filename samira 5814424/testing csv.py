...
with open('/tmp/pro2.csv', 'wb') as csvfile:
    ...
    headers = ["Company Name", "Sector", "Purchases", "Interest Payables", "Sales", "Expenses", "Interest Recivables", "Opening Stock", "Closing Stock"]
    
    for json_obj in data:
        company_name = json_obj["company"]["name"]
        sector = json_obj["sector"]
        purchases = json_obj["purchases"]
        interest_payable = json_obj["interest
