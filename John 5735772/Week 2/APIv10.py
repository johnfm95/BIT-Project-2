...
with open('Test14.csv', 'w') as csvfile:
    ...
    writer = csv.DictWriter(csvfile, fieldnames=fieldnames)
    writer.writeheader ()
    writer.writerow ({'title': 'company', 'result': CN1})
    writer.writerow ({'title': 'sector', 'result': S1})
    writer.writerow ({'title': 'CL', 'result': CL})
    writer.writerow ({'title': 'NCL', 'result': NCL})
